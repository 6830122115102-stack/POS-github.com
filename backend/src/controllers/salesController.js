...
class SalesController {
  constructor(saleRepository, saleItemRepository, productRepository, customerRepository, stockMovementRepository) {
  ...
  async createSale(req, res) {
    try {
      const { customer_id, items, tax_rate, discount_amount, payment_method } = req.body;
      ...
      const invoice_number = this._generateInvoiceNumber();
      ...
      const completeSale = await this.saleRepository.findById(sale_id);
      const saleItems = await this.saleItemRepository.query(
  ...
  async getSale(req, res) {
    try {
      const sale = await this.saleRepository.queryOne(
      ...
      const items = await this.saleItemRepository.query(
